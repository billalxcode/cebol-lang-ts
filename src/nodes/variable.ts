import type { CebolASTNode, CebolLexicalTokenEnum, CebolVariableNodeInterface } from "./types";

export class CebolVariableNode implements CebolVariableNodeInterface {
    public readonly name: string;
    public readonly varType: CebolLexicalTokenEnum.NUMBER | CebolLexicalTokenEnum.STRING;
